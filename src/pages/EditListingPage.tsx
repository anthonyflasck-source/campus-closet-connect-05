  ...
  useEffect(() => {
    ...
    supabase
      ...
      .then(({ data, error: fetchError }) => {
        ...
        const listing = data as DressListing;
        ...
        setDressLength(listing.condition || '');
        setEventType(listing.event_type || '');
        setListingType(listing.listing_type);
        setPrice(listing.purchase_price?.toString() || '');
        setRentalPrice(listing.rental_price_per_day?.toString() || '');
        setPickupLocation(listing.pickup_location_general || '');
        setPhotos(listing.image_urls || []);
      ...
      <main className="pt-24 pb-16 min-h-screen">
        <div className="container">
          <div className="border border-border rounded-3xl p-8 max-w-[680px] mx-auto animate-fade-in" style={{ background: 'var(--gradient-card)' }}>
            <h1 className="text-xl font-bold mb-1">Edit Listing</h1>
